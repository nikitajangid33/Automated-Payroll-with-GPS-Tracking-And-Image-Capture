...
urlpatterns=[
    ...
    path('user/<int:user_id>/employee/<str:empId>/monthlypayroll',views.employeeMonthlyPayrol,name='    path('user/<int:user_id>/employee/<str:empId>/monthlypayroll',views.employeeMonthlyPayrol,name='employeeNew'),
'),
